...
ActiveRecord::Schema.define(version: 20170709013416) do
  ...
  create_table "meal_plans", force: :cascade do |t|
    ...
    t.index ["users_id"], name: "index_meal_plans_on_users_id"
  end
  ...
  add_foreign_key "meal_plans", "users", column: "users_id"
